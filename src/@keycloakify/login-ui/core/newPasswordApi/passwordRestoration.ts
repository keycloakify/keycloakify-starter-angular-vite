...
import { generateEncryptionKey, encrypt, decrypt } from "../../../login-ui-angular/tools/symmetricEncryption";
import { addCookie, getCookie, removeCookie } from "../../../login-ui-angular/tools/cookie";
