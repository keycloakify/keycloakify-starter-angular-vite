...
import { extractLastParenthesisContent } from '../../../login-ui-angular/tools/extractLastParenthesisContent';
...
function createI18nTranslationFunctionsFactory<MessageKey_themeDefined extends string>(params: {
  ...
  function createI18nTranslationFunctions(params: {
  ...
  }): Pick<GenericI18n<MessageKey_defaultSet | MessageKey_themeDefined, string>, 'msgStr' | 'advancedMsgStr'> {
    ...
    function resolveMsg(props: { key: string; args: (string | undefined)[] }): string | undefined {
      ...
      const message =
        ...
        (() => {
          const messageOrMap = id<Record<string, string | Record<string, string> | undefined> | undefined>(
            messages_themeDefined,
          )?.[key];
